...
class Aeropuerto
{
    public:
        /* Constructores */
        Aeropuerto();
        Aeropuerto(int _id,string _nombre,string _abreviatura,int _totalAvionesOperacion, int _volumenMaximoPersonas, vector<int> aerolineas, vector<Aeropuerto> aeropuertosDestino);
        virtual ~Aeropuerto();
        /* Setters */
